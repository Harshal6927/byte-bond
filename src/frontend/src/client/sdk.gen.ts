 ...
 * CancelConnection
 */
export const apiGameCancelConnectionCancelConnection = <ThrowOnError extends boolean = false>(options?: Options<ApiGameCancelConnectionCancelConnectionData, ThrowOnError>) => {
...
export const apiQuestionsGetQuestions = <ThrowOnError extends boolean = false>(options?: Options<ApiQuestionsGetQuestionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiQuestionsGetQuestionsResponses, ApiQuestionsGetQuestionsErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                in: 'cookie',
