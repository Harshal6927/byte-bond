 ...
 * DeleteConnection
 */
export const apiConnectionsConnectionIdDeleteConnection = <ThrowOnError extends boolean = false>(options: Options<ApiConnectionsConnectionIdDeleteConnectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<ApiConnectionsConnectionIdDeleteConnectionResponses, ApiConnectionsConnectionIdDeleteConnectionErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * GetConnection
 */
export const apiConnectionsConnectionIdGetConnection = <ThrowOnError extends boolean = false>(options: Options<ApiConnectionsConnectionIdGetConnectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiConnectionsConnectionIdGetConnectionResponses, ApiConnectionsConnectionIdGetConnectionErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * PatchConnection
 */
export const apiConnectionsConnectionIdPatchConnection = <ThrowOnError extends boolean = false>(options: Options<ApiConnectionsConnectionIdPatchConnectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<ApiConnectionsConnectionIdPatchConnectionResponses, ApiConnectionsConnectionIdPatchConnectionErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * GetConnections
 */
export const apiConnectionsGetConnections = <ThrowOnError extends boolean = false>(options?: Options<ApiConnectionsGetConnectionsData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<ApiConnectionsGetConnectionsResponses, unknown, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * PostConnection
 */
export const apiConnectionsPostConnection = <ThrowOnError extends boolean = false>(options: Options<ApiConnectionsPostConnectionData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ApiConnectionsPostConnectionResponses, ApiConnectionsPostConnectionErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
 ...
 * GetLeaderboard
 */
export const apiGameLeaderboardEventIdGetLeaderboard = <ThrowOnError extends boolean = false>(options: Options<ApiGameLeaderboardEventIdGetLeaderboardData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<ApiGameLeaderboardEventIdGetLeaderboardResponses, ApiGameLeaderboardEventIdGetLeaderboardErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
